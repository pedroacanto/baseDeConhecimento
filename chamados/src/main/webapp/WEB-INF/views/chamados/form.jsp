...
<div class="container">
	<form:form action="/chamados" method="post" commandName="chamado" enctype="multipart/form-data">
		<div class="container">
			<form:form action="/chamados/chamados" method="post" commandName="chamado" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<form:input class ="form-control" placeholder="Funcionário do Banco Responsável" path="aberto_funcionario" />
				</div>
				<%--<div class='form-group'>--%>
				...
				<div class="form-group">
					<label for="funcionario-responsavel" >Selecione Funcionario Responsável: </label>
		...
		<a class="btn btn-primary" href="/chamados/">Voltar</a>
	</form:form>
</div>
